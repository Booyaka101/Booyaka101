...
<!-- auto:stamp -->
<sub>Live figures, rebuilt 2026-09-16.</sub>
<!-- /auto:stamp -->

<!-- auto:npm -->
> The packages I publish are pulling **1,361** installs a week between **18** of them, most of it `runner-drift` at 285.
<!-- /auto:npm -->
...
<!-- auto:radar -->
> Today's crawl checked **4,009** HACS integrations against core 2026.10 and found **2,157** deprecation hits across **825** repos. **2,411** are clean. Next up: **10** break in Home Assistant 2026.10.
<!-- /auto:radar -->
...
<!-- auto:upstream -->
When I depend on something and hit a real bug, I send the fix back. **49 merged PRs across 29 projects**, including core, koreader (2), nvim-lspconfig, gh-dash (2), ai-toolkit, sqlfluff (6), lualine.nvim, awesome-nodejs-security, minijinja, this-week-in-rust. 34 more open.
<!-- /auto:upstream -->
...
<!-- auto:fable -->
> Latest: [Day 51 — Couplet, a board game found by search](https://booyaka101.github.io/thedailyfable/day51/) · 2026-09-16 · 51 pieces so far.
<!-- /auto:fable -->
