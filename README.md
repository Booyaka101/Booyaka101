...
<!-- auto:radar -->
> Today's crawl checked **4,006** HACS integrations against core 2026.10 and found **2,113** deprecation hits across **816** repos. **3,177** are clean. Next up: **10** break in Home Assistant 2026.10.
<!-- /auto:radar -->
...
<!-- auto:census -->
> Today's census audited **3,238** packages from the registry: **28** run an install script, **17** score HIGH.
<!-- /auto:census -->
