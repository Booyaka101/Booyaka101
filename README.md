...
<!-- auto:stamp -->
<sub>Live figures, rebuilt 2026-08-27.</sub>
<!-- /auto:stamp -->
...
<!-- auto:radar -->
> Today's crawl checked **3,924** HACS integrations against core 2026.10 and found **2,250** deprecation hits across **852** repos. **2,306** are clean. Next up: **11** break in Home Assistant 2026.10.
<!-- /auto:radar -->
...
<!-- auto:census -->
> Today's census audited **3,026** packages from the registry: **23** run an install script, **16** score HIGH. Biggest is `esbuild` at 255.5M installs a week.
<!-- /auto:census -->
...
<!-- auto:fable -->
> Latest: [Day 31 — THE IMPOSSIBLE BELL: three bells no foundry could cast](https://booyaka101.github.io/thedailyfable/day31/) · 2026-08-27 · 31 pieces so far.
<!-- /auto:fable -->
